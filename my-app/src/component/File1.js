...
import { updateColor } from "../config/firestore";

function File1({ userSelection, setUserSelection, handleColor, setShowPalette, handleEdit, id, setId, queryColors,setLoading }) {
